#ifndef ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTATMATRIX
#define ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTATMATRIX

/* $Id: njn_localmaxstatmatrix.hpp 183505 2010-02-18 16:10:58Z boratyng $
* ===========================================================================
*
...
BEGIN_SCOPE(Njn_P)
    ...
    // The default dimMatrix2_ = 0 is equivalent to the same alphabet dimMatrix2_ = dimMatrix_.
        ...
        const Int4 *const *scoreMatrix_ = 0, // score matrix [0...dimMatrix_)[0...dimMatrix2_)
        ...
        inline ~LocalMaxStatMatrix () {free ();}
        ...
        inline const Int4 *const *getScoreMatrix () const {return d_scoreMatrix_p;} // score matrix [0...dimMatrix_)[0...dimMatrix_)
        ...
        Int4 **d_scoreMatrix_p; // score matrix [0...dimMatrix_)[0...dimMatrix_)
...
END_SCOPE(blast)
END_NCBI_SCOPE
#endif //! ALGO_BLAST_GUMBEL_PARAMS__INCLUDED_NJN_LOCALMAXSTATMATRIX
